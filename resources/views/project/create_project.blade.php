...
<div style="border: 1px solid rgba(0,0,0,0.1);">
    ...
    <div class="container">
        <form class="row mb-3" method="POST" action="/dashboard/project/store">
            @csrf
            <div class="col-6">
                <div class="form-group mb-3">
                    <label class="ml-1">Mã dự án</label>
                    <input type="code" class="form-control" name="code" placeholder="Nhập mã dự án">
                </div>
                <div class="form-group mb-3">
                    <label class="ml-1">Tên dự án</label>
                    <input type="name" class="form-control" name="name" placeholder="Nhập tên dự án">
                </div>
                <div class="form-group mb-3">
